...
whiteListItem = {98, 18, 32, 6336, 9640, 9310, 370,242}

joinRandomAfterFinish = true 
worldToJoin = {"MESRA","TOKOLAVA","TOKOJAYA"}
delayJoin = 7000

webhookInfo = "https://discord.com/api/webhooks/1205901671415414875/GKPuSvrk_f5kRq8mUzSAQZTsLLURb65XQJvqzuqqzDc6tCTYJZLwGadi6vpzePpzh_aD"
webhookNotif = "https://discord.com/api/webhooks/1205901452782870568/YrCeN9FeB5kWk5PpCZDHoZzhFbZ-9f3frYAvf9ZPULxWaFIj_nWmmVlleRUJ7ejdKb5-"
...
function methodFresh()
  ...
  bot:sendPacket(2,"action|dialog_return\ndialog_name|personalize_profile\nbuttonClicked|save\n\ncheckbox_show_achievements|1\ncheckbox_show_total_ach_count|1\ncheckbox_show_account_age|1\ncheckbox_show_homeworld|1")
  sleep(1000)
  botEvent("Claim Awesome")
  sleep(100)
  bot:sendPacket(2,"action|tutorial|TaskPhoneClicked")
  sleep(1000)
  ...
  bot:sendPacket(2,"action|dialog_return\ndialog_name|popup\nnetID|"..worldz.netid.."|\nbuttonClicked|goals")
  sleep(1000)
  bot:sendPacket(2,"action|dialog_return\ndialog_name|goalslist\nbuttonClicked|rolesmenu")
  sleep(1000)
